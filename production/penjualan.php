...
?>
 ...
 <!-- page content -->
          ...
          <div class="x_content">
                    ...
                    <form name="f" action="addcart.php" method="post" class="form-horizontal form-label-left" novalidate>
				...
				?>
					  ...
					  <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Discon <span class="required"></span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" name="jumlah" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
					  ...
					  <div>
					 <ul class="nav navbar-right panel_toolbox">
                                    <button type="submit" class="btn btn-dark "><span class="glyphicon glyphicon-plus "></span></button>
